...
public class PController implements UltrasonicController {
	...
	// Use this boolean to determine when the robot shall perform the p controller motion
	// (as there are times when we want to use the p controller to get information from the
	// ultrasonic sensor but not process the data and provide motion)
